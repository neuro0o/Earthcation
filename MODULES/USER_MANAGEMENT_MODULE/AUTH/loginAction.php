    ...
    <?php
      ...
      if (mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($userPwd, $row['userPwd'])) {
          ...
          else if ($row['userRole'] == 3) { // role: operator
            echo '<script type="text/javascript">
                    window.location.href = "' . BASE_URL . '/MODULES/OPERATOR_MANAGEMENT_MODULE/operatorHome.php";
                  </script>';
          }
          else if ($row['userRole'] == 4) { // role: accommodation
            echo '<script type="text/javascript">
                    window.location.href = "' . BASE_URL . '/MODULES/ACCOMMODATION_MANAGEMENT_MODULE/accommodationHome.php";
                  </script>';
          }
